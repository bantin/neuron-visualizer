...
Nav_params = {0,600,0.051,0.051,0.048,0.048};
Nav_inactivation = {340,700,1,1,0.0,0.0};
...
CalH_params = {400,600,0,0,0.,0.};
Cal_params = {0,0,0,0,0,0};
Car_params = {400,600,0,0,0.,0.};
Car_mag_params = {0,0,0,0,0,0};
Somacar_params = {0,0,0,0,0,0};
Cat_params = {400,600,0,0,0.,0.};
