...
#define _f_mhn _f_mhn__somacar 
#define mhn mhn__somacar 
...
#define usetable usetable_somacar
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_somacar", 0, 1,
 0,0,0
};
 ...
 "usetable_somacar", &usetable_somacar,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 somacar somacar.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "somacar.mod";
static const char* nmodl_file_text = 
