...
#define nrn_init _nrn_init__car_mag
#define _nrn_initial _nrn_initial__car_mag
#define nrn_cur _nrn_cur__car_mag
#define _nrn_current _nrn_current__car_mag
#define nrn_jacob _nrn_jacob__car_mag
#define nrn_state _nrn_state__car_mag
#define _net_receive _net_receive__car_mag 
#define kin kin__car_mag 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_car_mag", _hoc_setdata,
 "ghk_car_mag", _hoc_ghk,
 "ghkg_car_mag", _hoc_ghkg,
 0, 0
};
#define ghk ghk_car_mag
#define ghkg ghkg_car_mag
...
#define q10 q10_car_mag
 double q10 = 3;
#define taum_exp taum_exp_car_mag
 double taum_exp = 0.92;
#define z z_car_mag
 double z = 2;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gmax_car_mag", 0, 1e+09,
 0,0,0
};
 ...
 "q10_car_mag", &q10_car_mag,
 "taum_exp_car_mag", &taum_exp_car_mag,
 "z_car_mag", &z_car_mag,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 car_mag car_mag.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "car_mag.mod";
static const char* nmodl_file_text = 
